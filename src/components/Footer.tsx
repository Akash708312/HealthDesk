...
const Footer = ({ className = '' }: FooterProps) => {
  return (
    <footer className={`bg-white border-t py-8 ${className}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Your complete health management platform for disease tracking, preventive care, fitness, and more.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-600">akashjmp282@gmail.com</li>
              <li className="text-gray-600">+91 7479515000</li>
