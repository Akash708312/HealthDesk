            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <motion.div 
                  ...
                  className="mb-16"
                >
                  <h2 className="text-3xl font-bold mb-6">Why Join HealthDesk?</h2>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mt-12">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      <div className="flex flex-col items-center text-center">
                        ...
                        />
                        <h3 className="text-xl font-bold text-gray-900">Sweksha Shukla</h3>
                        ...
                        <div className="flex flex-col space-y-3">
                          <a href="mailto:love@wrlds.com" className="flex items-center text-gray-700 hover:text-blue-600">
                            ...
                            swekshashukla@healthdesk.com
                          </a>
                          <a 
                            href=" https://www.linkedin.com/in/sweksha-shukla-35319b276/"
                            target="_blank"
